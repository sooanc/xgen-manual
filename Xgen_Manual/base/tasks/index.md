...
> AI Agent를 **실행해서 결과를 받는** 것이 주 업무인 사용자. 회사가 미리 만들어둔 Agent를 채팅으로 활용합니다.

### Agent와 채팅하고 싶다
- 시작 위치: 좌측 사이드바 **Agent 채팅 → 새 채팅**
- 절차: [채팅 사용](../user/14-chat.md)

### Agent에게 사내 문서를 참고하게 하고 싶다
...
> 자기 업무를 자동화할 Agent를 **직접 설계·배포**하는 사용자. 일반 사용자보다 한 단계 깊이 솔루션을 다룹니다.

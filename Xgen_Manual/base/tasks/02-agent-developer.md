...
- 절차: [패스파인더 사용하기](../user/12b-pathfinder.md)
- 핵심: XGEN 캔버스에서 AI 에이전트 워크플로우를 만드는 것을 도와주는 어시스턴트. 대화로 필요한 노드를 찾아 캔버스에 구성하고, 도구 연동·화면 조작까지 지원. 생성 후 상세 편집은 [에이전트 만들기](../user/12-agentflow-create.md) 참고.
<!-- require_view_end -->

...
2. Enter:
    ...
    - **Expiration date** (default): scheduled auto-delete date. You can set it up to {{vars.knowledge_ttl_max_days}} day(s) ahead (default {{vars.knowledge_ttl_default_days}} day(s)). After expiry the collection is permanently deleted following a 14-day grace period.{{vars.knowledge_ttl_permanent_note_en}}
3. **Create**

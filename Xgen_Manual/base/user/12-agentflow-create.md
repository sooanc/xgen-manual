...
!!! info "노드 상세 패널 캡처"
    개별 노드를 클릭하면 우측에 상세 설정 패널이 펼쳐집니다. 노드 타입(LLM / 도구 / 검색 / 분기 등) 마다 필드 구성이 다르며, 대표 예시는 다음과 같습니다.

    ![노드 상세 패널 — 예시 1](images/canvas-node1.png)

    ![노드 상세 패널 — 예시 2](images/canvas-node2.png)

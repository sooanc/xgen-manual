...
!!! note "Agent 제작 권한 필요"
    본 절차는 **Agent 개발자** 역할(또는 동등한 권한)을 부여받은 계정에서 따라야 합니다. 일반 사용자(Standard User) 계정에는 사이드바에 **Agent 제작** 섹션이 노출되지 않으며, [대시보드 · Agent 작업실 단축 버튼](18-dashboard.md) 으로 진입해도 페이지 본문이 비어 보입니다.

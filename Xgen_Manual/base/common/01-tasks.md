...
- 표시 범위: 일반 사용자 권한을 가진 모든 사용자에게 동일하게 노출되는 메인 화면. 공지·FAQ·자주 찾는 Agent·서비스 요청 등 일반 사용자 영역의 기본 콘텐츠를 모아 보여줌. 거버넌스·시스템 운영 위젯은 관리자 권한이 있을 때만 추가로 노출됨.
...
- [용어 정의](02-glossary.md) — 매뉴얼 전반에서 쓰는 용어

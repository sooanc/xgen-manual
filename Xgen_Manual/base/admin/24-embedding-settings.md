...
![리랭커 탭 — 상단의 *현재 활성 제공자* 카드와 *사용 가능한 리랭커 제공자* (Sentence Transformers / vLLM Server) 카드, 활성 제공자 하단의 *리랭커 모델 / 디바이스* 등 설정 항목](images/admin-embedding-reranker-tab.png)
...
![벡터 데이터베이스 탭 — 상단의 *현재 활성 제공자* 카드와 Qdrant 연결 정보(벡터 차원·호스트·포트·API 키·gRPC 사용) 설정 항목들](images/admin-embedding-vectordb-tab.png)

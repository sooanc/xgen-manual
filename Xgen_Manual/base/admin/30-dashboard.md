...
![최수안(시스템 관리자) 계정으로 본 /dashboard — "System Operations & Deployment Dashboard" 부제와 일반 위젯에 더해 Agent 배포/승인 상태·최근 사용자 피드백·공유 자산 현황 등 운영 위젯이 함께 노출된 모습](images/dashboard-system-admin.png)
...
시스템 관리자 뷰의 운영 위젯에 더해, 다음 거버넌스 정책 위젯이 추가로 노출됩니다.
...
![최수안(거버넌스) 계정으로 본 /dashboard — 동일한 "System Operations & Deployment Dashboard" 부제 아래에 위험 등급 정책·금칙어 정책·승인 대기 큐 등 거버넌스 위젯과 운영 위젯이 함께 노출된 모습](images/dashboard-governance.png)

...
운영 DB 데이터 변경(INSERT/UPDATE/DELETE/DDL) 에 대한 감사 로그. 누가·언제·어느 테이블·어떤 행을 변경했는지 추적합니다. 시스템 관리자 작업 감사는 [감사 로그](27-audit-log.md) 챕터를 참고.
...
- [감사 로그](27-audit-log.md) — 시스템·관리자 작업에 대한 감사 (데이터 변경 감사와는 분리)
- [시스템 모니터](26-system-monitor.md) — DB 자체의 성능·디스크 사용량 모니터링

## 문의

데이터 관리 화면 관련 문의는 **XGen 관리자**({{vars.support_email}}) 로 연락해 주세요.

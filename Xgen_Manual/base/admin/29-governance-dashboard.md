...
| 3 | **AI 서비스 변경 이력** | (서비스·운영 변경 이력 목록) | [감사·추적 관리](#audit-tracking) | 단일 화면, 필터·검색 |
...
승인·반려 모든 처리는 [감사 로그](27-audit-log.md) 와 [AI 감사·추적 관리](#audit-tracking) 에 기록되며, 심사자(`governance_reviewed_by`)·코멘트(`governance_review_comment`)·일시가 영구 보존됩니다.

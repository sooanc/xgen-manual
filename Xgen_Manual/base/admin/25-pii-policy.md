...
!!! note "정책 생성 모달 캡처는 별도 갱신 예정"
    "PII 생성" 클릭 시 노출되는 정규식 입력·테스트 모달의 캡처는 다음 회차에 보강 예정입니다.
...
정책 저장 후 [AI 거버넌스 - 위험도 평가 및 심사](29-governance-dashboard.md#ai-위험도-평가-및-심사) 에서 신규 에이전트가 자동 평가되며, 결과 등급에 따라 승인 대기 큐에 적재됩니다.
